...
# Calculate the Gaussian probability distribution function for x
    ...
    #dataset.columns = ['id', 'limit_bal', 'gender', 'education', 'marital_status', 'age', 'pay_sept', 'pay_aug', 'pay_july', 'pay_june', 'pay_may', 'pay_apr', 'bill_sept', 'bill_aug', 'bill_july', 'bill_june', 'bill_may', 'bill_apr', 'paid_sept', 'paid_aug', 'paid_july', 'paid_june', 'paid_may', 'paid_apr', 'default']
