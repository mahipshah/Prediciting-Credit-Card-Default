...
def SVM_Linear():
	...
	file_obj=open("Training_Dataset_short_headerless_2.csv", "r")
	...
	file_obj=open("Testing_Dataset_headerless_2.csv", "r")
	raw_data=np.loadtxt(file_obj, delimiter=',')
	x_test=[]
	y_test=0
	y_pred=[]
...
def SVM_Kernel():
	...
	df_train=pd.read_csv("Training_Dataset_orig_2.csv")
	...
	df_test=pd.read_csv("Testing_Dataset_orig_2.csv")
